 ...
 */
 ...
 import configDashbord from '../../plugin/components/financial-dashboard/config.json';
 ...
 export const componentsData = {
     ...
     'financial-dashboard': {
        pluginComponentName: 'financial-dashboard',
        componentName: 'financial-dashboard',
        props: {
            ...configDashbord.props,
            ...generateStandardProps(configDashbord),
            // mock营销态数据-可自行修改
            promotionState: 'STANDARD_WORKTAB',
            tryoutAddress: 'https://www.dingtalk.com',
        }
